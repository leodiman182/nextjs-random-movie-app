export default function MainCard() {
  ...
  return (
    <article className="bg-black py-[30px] px-[20px] lg:p-[50px] rounded-md text-center lg:w-[500px]">
      ...
      <button className="text bg-primary rounded-md py-[10px] px-[20px] lg:px-[40px] text-white lg:text-[28px] my-[50px] opacity-80 hover:opacity-100 hover:bg-white hover:text-primary hover:scale-110 duration-150">
        Surprise me!
      </button>
